#!/bin/bash
# Install Git hooks for agentax project
#
...
echo "Installing Git hooks for agentax..."
...
echo "Hook behavior:"
echo ""
echo "  Version Bumping (post-commit, main branch only):"
echo "    - Commits with .swift files: Auto-bump patch version (0.1.0 -> 0.1.1)"
echo "    - [minor] in commit msg: Bump minor version (0.1.0 -> 0.2.0)"
echo "    - [major] in commit msg: Bump major version (0.1.0 -> 1.0.0)"
